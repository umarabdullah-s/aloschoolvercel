      ...
      <div className={styles.wrapper}>
        <div className={styles.content}>
          ...
          <p className={`${styles.title} ${styles.title1}`}>
            Diploma In <span>Artificial Intelligence</span>
          </p>

          <p className={styles.title2}>
           The Diploma in Artificial Intelligence is a program designed for<br/> students and professionals to build strong knowledge in AI concepts, machine learning, and real-world applications,enabling them to understand and apply intelligent systems across various domains.
          </p>
