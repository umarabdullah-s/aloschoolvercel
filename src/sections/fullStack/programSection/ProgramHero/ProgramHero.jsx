      ...
      <div className={styles.wrapper}>
        <div className={styles.content}>
          ...
          <p className={`${styles.title} ${styles.title1}`}>
            Diploma In <span>FullStack Development</span>
          </p>

          <p className={styles.title2}>
           The Diploma in Full Stack Development is a career focused program designed for  <br />
   students and professionals who want to develop strong expertise in building dynamic websites ,<br />
     managing databases, and creating scalable web applications.
          </p>
