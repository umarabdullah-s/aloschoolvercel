      ...
      <div className={styles.wrapper}>
        <div className={styles.content}>
          ...
          <p className={`${styles.title} ${styles.title1}`}>
            Diploma In <span>VFX & Animation</span>
          </p>

          <p className={styles.title2}>
           The Diploma in VFX & Animation is a career-focused program created for <br />
          students and professionals who want to develop strong skills in animation, visual effects, motion graphics,<br />
